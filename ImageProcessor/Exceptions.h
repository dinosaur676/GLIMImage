...
/// Logger 초기화 안했을때 발생하는 오류
class LoggerNotInitError : public std::runtime_error {
public:
    explicit LoggerNotInitError(const std::string& msg)
        : std::runtime_error("[LoggerNotInit] " + msg) {}
};
